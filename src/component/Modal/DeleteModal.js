...
import { DeleteButton, CloseButton } from "../../component/Button";
import ModalHeader from "./ModalHeader";
import ModalBody from "./ModalBody";
import ModalFooter from "./ModalFooter";

const DeleteModal = React.memo((props) => {
  const { isLoading, msg, color, icon, toggleOpen, onClick, ...attr } = props;
  return (
    <Modal noBackDrop color={color} {...attr}>
      <ModalHeader toggleOpen={toggleOpen} icon={icon} title="Delete Confirm" />
      <ModalBody>
